...
class Network(nn.Module):
    def __init__(self, batch_norm, activation, weight=0.125, pool=nn.MaxPool2d(2), prep_block=conv_bn_self, conv_bn=conv_bn_act_pool):
        super(Network, self).__init__()
        channels = {'prep': 64, 'layer1': 128, 'layer2': 256, 'layer3': 512}
        self.prep = conv_bn_self(3, channels['prep'], batch_norm=batch_norm, activation=activation)
